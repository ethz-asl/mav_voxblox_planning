...
if(NOT "/home/davide/catkin_ws/src/mav_voxblox_planning/voxblox_skeleton/include;/home/davide/catkin_ws/src/mav_voxblox_planning/voxblox_skeleton/cmake-build-debug " STREQUAL " ")
  set(voxblox_skeleton_INCLUDE_DIRS "")
  set(_include_dirs "/home/davide/catkin_ws/src/mav_voxblox_planning/voxblox_skeleton/include;/home/davide/catkin_ws/src/mav_voxblox_planning/voxblox_skeleton/cmake-build-debug")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'voxblox_skeleton' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/davide/catkin_ws/src/mav_voxblox_planning/voxblox_skeleton/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/davide/catkin_ws/src/mav_voxblox_planning/voxblox_skeleton/cmake-build-debug/devel/lib;/home/davide/catkin_ws/devel/lib;/opt/ros/melodic/lib)
