#include "voxblox_rrt_planner/blox_ompl_rrt.h"

namespace mav_planning {

BloxOmplRrt::BloxOmplRrt(const ros::NodeHandle& nh,
...
void BloxOmplRrt::setBounds(const Eigen::Vector3d& lower_bound,
...
bool BloxOmplRrt::getPathBetweenWaypoints(
...
void BloxOmplRrt::setupFromStartAndGoal(
    const mav_msgs::EigenTrajectoryPoint& start,
    const mav_msgs::EigenTrajectoryPoint& goal) {
...
void BloxOmplRrt::solutionPathToTrajectoryPoints(
...
bool BloxOmplRrt::getBestPathTowardGoal(
    const mav_msgs::EigenTrajectoryPoint& start,
    const mav_msgs::EigenTrajectoryPoint& goal,
...
double BloxOmplRrt::getDistanceEigenToState(
